    ...
    <div class="container">
      <h1>Cadastro de Cliente</h1>
        ...
        <div class="col-3">
            ...
            <input type="text" class="form-control" name="login" value="<?php echo !empty($data->login) ? $data->login : "" ?>">
        </div>
        <div class="col-3">
            <label class="form-label">Senha</label><br>
            <input type="text" class="form-control" name="senha" value="<?php echo !empty($data->senha) ? $data->senha : "" ?>">
        </div>
        <br>
            <input type="submit" style="background-color:#800000; color:white" class="btn" value="Salvar"/>
            <a href="clienteList.php" style="background-color:#800000; color:white" class="btn">Voltar</a>
        </form>
